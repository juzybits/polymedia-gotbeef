...
export function Home() {
    ...
    return <React.Fragment>
        <div>
            <p>
                <i>Got Beef?</i> is a dApp to make on-chain bets on the <a href="https://sui.io/" className="rainbow" target="_blank" rel="noopener noreferrer">Sui network</a>.
            </p>
            <p>
            ...
            {showWhatIsFor && <div className="section-body" id="section-what-is-for">
                In <a href="https://twitter.com/GiganticRebirth/status/1503335929976664065" className="rainbow" target="_blank" rel="noopener noreferrer">this scenario</a>, <i>Got Beef?</i> could have been used:
                <ul>
                    <li>player 1 = GCR</li>
